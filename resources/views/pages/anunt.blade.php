        ...
        <div class="row margin-top-20">
            <div class="col-sm-9 col-xs-9 contentAnunt">
                ...
                <div class="col-sm-12 col-xs-12 legendTitle">
                    ...
                    <div class="col-sm-12 col-xs-12">  <span class="display-inline font-size-20px"> <img src="images/google-map/terenuri-marker.png" style="margin-right: 12px;" class="legend display-inline"></img>Terenuri de vanzare/inchiriere</span></div>
                    
                    <div class="col-sm-12 col-xs-12">  <span class="display-inline font-size-20px"> <img src="images/google-map/birouri-marker.png" style="margin-right: 12px;" class="legend display-inline"></img>Birouri de vanzare/inchiriere</span></div>
                    
                    <div class="col-sm-12 col-xs-12">  <span class="display-inline font-size-20px"> <img src="images/google-map/locuinte-marker.png" style="margin-right: 12px;" class="legend display-inline"></img>Locuinte de vanzare/inchiriere</span></div>
